package com.saludaunclic.semefa.regafi.service.setup
...
class AppSetupService(private val userService: UserService,
                      private val regafiMapper: RegoofyMapper) {
    ...
    fun setupApp(appSetup: AppSetupDto): String {
        ...
        val user = userService.save(regafiMapper.toModel(appSetup.user).apply {
