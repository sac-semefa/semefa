...
): BaseSitedsHandler<GetConsultaProcRequest, GetConsultaProcResponse>() {
    companion object {
        const val PATH: String = "/conproc"
    }

    override fun handleRequest(request: GetConsultaProcRequest) {
        ...
        val bean: InConProc271 = sendBean(sitedsProperties.sacUrl + PATH, inConAse270, InConProc271::class.java)
        val x12: String = in271ConProcService.beanToX12N(bean)
        logConvertResponse(logger, bean, x12)
    }

    override fun createResponse(errorCode: String): GetConsultaProcResponse =
