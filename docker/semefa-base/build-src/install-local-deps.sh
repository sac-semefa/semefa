...
./mvnw -q install:install-file -Dfile=./libs/jr-afiliacion-susalud-1.0.0.jar -DgroupId=pe.gob.susalud -DartifactId=jr-afiliacion-susalud -Dversion=1.0.0 -Dpackaging=jar
